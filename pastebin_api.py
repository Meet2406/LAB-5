...
API_DEV_KEY = 'XoGxLiOgTK98J16xqdnnee5DM5ZzZXjz'
...
def post_new_paste(title, body_text, expiration='N', listed=True):
    ...
    """    
    # TODO: Function body
    # Seyup the POST message parameters:
    params = {
